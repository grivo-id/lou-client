...
export async function generateMetadata({ params }: { params: { addOnsName: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: addOnsData.description,
      images: [addOnsData.main_image, addOnsData.sub_image1, addOnsData.sub_image2].filter(Boolean),
...
const generateJsonLd = (addOnDetail: AddOnDetail) => {
  ...
  return {
    ...
    image: [addOnDetail.main_image, addOnDetail.sub_image1, addOnDetail.sub_image2].filter(Boolean),
